...
| `heatFactor`         |     float      |           2           | The temperature added to the player per frame if player is hit by the laser. _The value varies according to player's current temperature._                                                                               |
